...
document.getElementById("blankOne").innerHTML = questionOne; /* Returns the response in text */
...
var questionOne = prompt("Sorry... Just one more question. What would you do if I told this was a test and you pass and won the jackpot?");
document.getElementById("blankFive").innerHTML = questionOne ;


/* Name and Date */
var myName = "Jayben Villacarte";
console.log(myName);
